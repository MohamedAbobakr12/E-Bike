        ...
        <section className="flex w-full h-max bg-BG mt-14">
            <div className="max-w-screen-xl w-full mx-auto mb-32 max-xl:mb-24 max-lg:mb-20 max-md:mb-14">
                ...
                <div className="flex max-lg:flex-col max-xl:flex-wrap justify-around max-w-6xl max-xl:max-w-5xl max-lg:w-max max-lg:gap-y-8 h-max mx-auto mt-16">
                    <div className="flex flex-col justify-center w-[33rem] max-xl:w-[30rem] max-md:w-[28rem] max-lg:h-[35rem] max-md:mx-auto bg-white rounded-lg">
                        ...
                        <div className="flex justify-center w-max mt-2 mx-auto">
                            <Image 
                                width={450} 
                                height={300} 
                                src={"/bike3.png"} 
                    ...
                    <div className="flex flex-col gap-y-5 w-[33rem] max-xl:w-[30rem] max-md:w-[28rem] h-max">
                        <div className="flex justify-around border-2 border-white rounded-md h-[50%] bg-white w-full">
                            <div className="flex flex-col mt-8 w-[50%] h-max">
                                <h1 className="text-2xl text-center font-semibold">ACCESSOORIES</h1>
                                <p className="text-lg max-xl:text-sm text-gray-900 w-[75%] mt-5 self-center">Close-out pricing on dozens of products</p>
                                <Link href={"#"} className="text-brand-600 hover:text-white border-2 border-brand-600 hover:bg-brand-600 w-max rounded px-14 max-xl:px-10 py-4 mx-auto mt-6 transition-all duration-300"><span className="text-xl">Shop Now</span></Link>
                            </div>
