                ...
                <div className="max-w-screen-xl mx-auto">
                    <div className="flex flex-wrap justify-between mx-4">
                        <div className="flex flex-col flex-wrap mt-12">
                            ...
                            <p className="text-gray-200 text-md max-md:w-[24rem] w-[31rem] mt-12 max-md:mt-8">From sleek road bikes built for speed to rugged mountain bikes designed for off-road adventures, our slider celebrates the diversity of cycling disciplines.</p>
                        ...
                        <div className="flex flex-wrap flex-col max-md:max-w-xl max-md:w-full items-center mt-10 max-xl:mx-auto">
                            <div className="relative md:left-9 w-[28rem] max-md:w-[16rem] h-64 max-md:h-[10rem] mt-4 left-0">
                                <div className="flex relative items-center bg-brand-700 -right-16 w-full h-full mx-auto">
                                    <div className="flex relative items-center left-12 w-[80%]">
                                        <div className="flex flex-col relative justify-center max-md:left-16 items-center border-green-950 w-full max-md:w-max">
                                        <Image 
                                            width={70} 
                                            height={70} 
                                            src={"/hero.png"} 
                                        ...
                                        />
                                        <p className="mt-4 text-lg max-md:text-md font-medium max-md:font-normal text-white leading-7 text-center">Fast Charging <br /> Support</p>
                                        </div>
                                        <div className="flex absolute -left-64 max-md:-left-40 bg-gray-950 rounded-lg w-80 max-md:w-52 h-52 max-md:h-[8rem] px-4 max-md:px-2">
                                            <Image 
                                                width={275} 
                                                height={200} 
                                                src={"/bike1.png"} 
                                                alt={"bike1 image"} 
                                                className="self-center max-md:w-48"
                                            />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="relative flex items-center w-full mt-5">
                                <Image 
                                    ...
                                    src={"/wallpaper.jpg"} 
                                    alt={"wallpaper image"} 
                                    className="rounded-lg w-[40.3rem] max-md:w-full h-52 max-md:h-44"
                                />
                                <div className="absolute flex flex-col items-center justify-center left-96 max-md:left-64 w-36 max-md:w-28 h-24 max-md:h-20 bg-gray-50 border-2 border-brand-600 rounded-xl md:shadow-outer">
                                    <h4 className="text-2xl font-semibold text-brand-600">45 KM</h4>
                                    <p className="text-lg text-brand-600">PER HOUR</p>
                                </div>
                            </div>
                        </div>

                        <div className="flex justify-center w-full gap-8 mt-14 md:hidden">
